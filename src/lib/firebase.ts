...
// Use server-side variables for backend initialization.
...
if (!firebaseConfig.projectId) {
  throw new Error("Firebase Error: FIREBASE_PROJECT_ID is not defined. Please check your Vercel environment variables.");
}
if (!firebaseConfig.apiKey) {
    throw new Error("Firebase Error: FIREBASE_API_KEY is not defined. Please check your Vercel environment variables.");
}
